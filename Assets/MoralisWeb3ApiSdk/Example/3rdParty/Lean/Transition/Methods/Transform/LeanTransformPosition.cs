...
namespace Lean.Transition.Method
{
	...
	[UnityEngine.HelpURL(LeanTransition.HelpUrlPrefix + "LeanTransformPosition")]
	[UnityEngine.AddComponentMenu(LeanTransition.MethodsMenuPrefix + "Transform/Transform.position" + LeanTransition.MethodsMenuSuffix + "(LeanTransformPosition)")]
	public class LeanTransformPosition : LeanMethodWithStateAndTarget
	{
		...
		public class State : LeanStateWithTarget<TARGET>
		{
			...
			public override int CanFill
			{
				get
				{
					return Target != null && Target.position != Value ? 1 : 0;
				}
			}
...
namespace Lean.Transition
{
	...
	{
		public static TARGET positionTransition(this TARGET target, UnityEngine.Vector3 value, float duration, LeanEase ease = LeanEase.Smooth)
		{
			Method.LeanTransformPosition.Register(target, value, duration, ease); return target;
		}
	}
}