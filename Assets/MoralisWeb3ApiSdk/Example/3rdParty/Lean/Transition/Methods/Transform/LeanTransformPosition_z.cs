...
namespace Lean.Transition.Method
{
	...
	[UnityEngine.HelpURL(LeanTransition.HelpUrlPrefix + "LeanTransformPosition_Z")]
	[UnityEngine.AddComponentMenu(LeanTransition.MethodsMenuPrefix + "Transform/Transform.position.z" + LeanTransition.MethodsMenuSuffix + "(LeanTransformPosition_Z)")]
	public class LeanTransformPosition_Z : LeanMethodWithStateAndTarget
	{
		...
		public class State : LeanStateWithTarget<TARGET>
		{
			...
			public override int CanFill
			{
				get
				{
					return Target != null && Target.position.z != Value ? 1 : 0;
				}
			}
...
namespace Lean.Transition
{
	...
	{
		public static TARGET positionTransition_z(this TARGET target, float value, float duration, LeanEase ease = LeanEase.Smooth)
		{
			Method.LeanTransformPosition_Z.Register(target, value, duration, ease); return target;
		}
	}
}