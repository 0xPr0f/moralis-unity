...
namespace Lean.Transition.Method
{
	...
	[UnityEngine.HelpURL(LeanTransition.HelpUrlPrefix + "LeanTransformLocalScale_x")]
	[UnityEngine.AddComponentMenu(LeanTransition.MethodsMenuPrefix + "Transform/Transform.localScale.x" + LeanTransition.MethodsMenuSuffix + "(LeanTransformLocalScale_x)")]
	public class LeanTransformLocalScale_x : LeanMethodWithStateAndTarget
	{
		...
		public class State : LeanStateWithTarget<TARGET>
		{
			...
			public override int CanFill
			{
				get
				{
					return Target != null && Target.localScale.x != Value ? 1 : 0;
				}
			}
...
namespace Lean.Transition
{
	...
	{
		public static TARGET localScaleTransition_x(this TARGET target, float value, float duration, LeanEase ease = LeanEase.Smooth)
		{
			Method.LeanTransformLocalScale_x.Register(target, value, duration, ease); return target;
		}
	}
}