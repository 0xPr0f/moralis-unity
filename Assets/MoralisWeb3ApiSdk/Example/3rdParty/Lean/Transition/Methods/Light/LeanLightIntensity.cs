...
namespace Lean.Transition.Method
{
	...
	[UnityEngine.HelpURL(LeanTransition.HelpUrlPrefix + "LeanLightIntensity")]
	[UnityEngine.AddComponentMenu(LeanTransition.MethodsMenuPrefix + "Light/Light.intensity" + LeanTransition.MethodsMenuSuffix + "(LeanLightIntensity)")]
	public class LeanLightIntensity : LeanMethodWithStateAndTarget
	{
		...
		public class State : LeanStateWithTarget<TARGET>
		{
			...
			[UnityEngine.Serialization.FormerlySerializedAs("Intensity")]public float Value = 1.0f;
			...
			public override int CanFill
			{
				get
				{
					return Target != null && Target.intensity != Value ? 1 : 0;
				}
			}
...
namespace Lean.Transition
{
	...
	{
		public static TARGET intensityTransition(this TARGET target, float value, float duration, LeanEase ease = LeanEase.Smooth)
		{
			Method.LeanLightIntensity.Register(target, value, duration, ease); return target;
		}
	}
}