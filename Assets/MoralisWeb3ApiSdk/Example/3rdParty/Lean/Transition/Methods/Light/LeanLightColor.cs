...
namespace Lean.Transition.Method
{
	...
	[UnityEngine.HelpURL(LeanTransition.HelpUrlPrefix + "LeanLightColor")]
	[UnityEngine.AddComponentMenu(LeanTransition.MethodsMenuPrefix + "Light/Light.color" + LeanTransition.MethodsMenuSuffix + "(LeanLightColor)")]
...
namespace Lean.Transition
{
	public static partial class LeanExtensions
	{
		...
		{
			Method.LeanLightColor.Register(target, value, duration, ease); return target;
		}
	}
}