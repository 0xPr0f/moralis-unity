...
namespace Lean.Transition.Method
{
	...
	[UnityEngine.HelpURL(LeanTransition.HelpUrlPrefix + "LeanRectTransformAnchorMax_x")]
	[UnityEngine.AddComponentMenu(LeanTransition.MethodsMenuPrefix + "RectTransform/RectTransform.anchorMax.x" + LeanTransition.MethodsMenuSuffix + "(LeanRectTransformAnchorMax_x)")]
	public class LeanRectTransformAnchorMax_x : LeanMethodWithStateAndTarget
	{
		...
		public class State : LeanStateWithTarget<TARGET>
		{
			...
			public override int CanFill
			{
				get
				{
					return Target != null && Target.anchorMax.x != Value ? 1 : 0;
				}
			}
...
namespace Lean.Transition
{
	...
	{
		public static TARGET anchorMaxTransition_x(this TARGET target, float value, float duration, LeanEase ease = LeanEase.Smooth)
		{
			Method.LeanRectTransformAnchorMax_x.Register(target, value, duration, ease); return target;
		}
	}
}