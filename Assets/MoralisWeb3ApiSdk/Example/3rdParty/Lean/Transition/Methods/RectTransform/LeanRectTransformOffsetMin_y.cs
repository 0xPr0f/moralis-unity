...
namespace Lean.Transition.Method
{
	...
	[UnityEngine.HelpURL(LeanTransition.HelpUrlPrefix + "LeanRectTransformOffsetMin_y")]
	[UnityEngine.AddComponentMenu(LeanTransition.MethodsMenuPrefix + "RectTransform/RectTransform.offsetMin.y" + LeanTransition.MethodsMenuSuffix + "(LeanRectTransformOffsetMin_y)")]
	public class LeanRectTransformOffsetMin_y : LeanMethodWithStateAndTarget
	{
		...
		public class State : LeanStateWithTarget<TARGET>
		{
			...
			public override int CanFill
			{
				get
				{
					return Target != null && Target.offsetMin.y != Value ? 1 : 0;
				}
			}
...
namespace Lean.Transition
{
	...
	{
		public static TARGET offsetMinTransition_y(this TARGET target, float value, float duration, LeanEase ease = LeanEase.Smooth)
		{
			Method.LeanRectTransformOffsetMin_y.Register(target, value, duration, ease); return target;
		}
	}
}